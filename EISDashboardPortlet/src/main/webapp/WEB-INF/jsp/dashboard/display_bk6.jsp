...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span8">
            <div class="row">
                <div class="span6 pad">
                    <div class="title"> <img src="/EISDashboardPortlet/resources/images/ICON_1.png" width="44" height="40">
                        <span class="txtHead" style="font-family: 'Britannic'">${kissLanguage.languageMap['student']}</span>
                        <select id="${ns}year" >
                        ...
                        <input type="button" value="Filter" onclick="${ns}renderDashboard()"/>
                        <form:form  id="dashboardForm" modelAttribute="dashboardForm" method="post"  name="dashboardForm" action="${formAction}" enctype="multipart/form-data">
                            ...
                            <span onclick="${ns}doSubmit('eng')">Eng</span> |
                            <span onclick="${ns}doSubmit('th')">Thai</span>
                        </form:form>
                    </div>
                ...
                <div class="span6">
                    <div class="row">
                        <div class="span12 pad">
                            <div class="title"> <img src="/EISDashboardPortlet/resources/images/ICON_8.png" width="55" height="38"> <span class="txtHead" style="font-family: 'Britannic'">${kissLanguage.languageMap['academic']}</span> </div>
                            <div class="stdBox">
                                <div class="row">
                                    <div class="span12">
        ...
        <div class="span4">
            <div class="row">
                <div class="span12 pad">
                    ...
                    <div class="smlBlue midle textC">Incomes <span id="income_amount_format"></span> Million Baht</div>
                    <div>
                        <div id="${ns}chartContainer2"></div>
                        <!-- legend in pie -->
                        <div class="typeChart whiteText" style="top: 58%;left: 85%;">EXPENSES</div>
                    </div>
                    <div class="smlBlue midle textC">Expenses <span id="expense_amount_format"></span> Million Baht</div>
                </div>
                <div class="span12 pad">
